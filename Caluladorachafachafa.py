...
num1=tk.Button(text="1",command=lambda:texto.insert(len(texto.get()),"1"), width=3, height=3)
num1.grid(column=1,row=1)
num2=tk.Button(text="2", command=lambda:texto.insert(len(texto.get()),"2"), width=3, height=3)
num2.grid(column=2, row=1)
num3=tk.Button(text="3", command=lambda:texto.insert(len(texto.get()),"3"), width=3, height=3)
num3.grid(column=3, row=1)
num4=tk.Button(text="4", command=lambda:texto.insert(len(texto.get()),"4"), width=3, height=3)
num4.grid(column=1, row=2)
num5=tk.Button(text="5", command=lambda:texto.insert(len(texto.get()),"5"), width=3, height=3)
num5.grid(column=2, row=2)
num6=tk.Button(text="6", command=lambda:texto.insert(len(texto.get()),"6"), width=3, height=3)
num6.grid(column=3, row=2)
num7=tk.Button(text="7", command=lambda:texto.insert(len(texto.get()),"7"), width=3, height=3)
num7.grid(column=1, row=3)
num8=tk.Button(text="8", command=lambda:texto.insert(len(texto.get()),"8"), width=3, height=3)
num8.grid(column=2, row=3)
num9=tk.Button(text="9", command=lambda:texto.insert(len(texto.get()),"9"), width=3, height=3)
num9.grid(column=3, row=3)
num0=tk.Button(text="0", command=lambda:texto.insert(len(texto.get()),"0"), width=3, height=3)
...
borrar=tk.Button(text="<-", command=lambda:texto.delete(len(texto.get())-1,len(texto.get())), width=3, height=3)
borrar.grid(column=2, row=5)
clear=tk.Button(text="C", command=lambda:texto.delete(0,len(texto.get())), width=3, height=3)
clear.grid(column=1, row=5)
punto=tk.Button(text=".", command=lambda:texto.insert(len(texto.get()),"."), width=3, height=3)
