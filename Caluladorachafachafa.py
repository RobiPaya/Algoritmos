...
>>>>>>> db6068849356505ed5e6d99d9ff4b04efafd4f63
texto=tk.Entry()
...
suma=tk.Button(text="+", command=func10, width=1, height=1)
suma.grid(column=4, row=1)
resta=tk.Button(text="-", command=func11, width=1, height=1)
resta.grid(column=4, row=2)
multiplicacion=tk.Button(text="*", command=func12, width=1, height=1)
multiplicacion.grid(column=4, row=3)
division=tk.Button(text="/", command=func13, width=1, height=1)
division.grid(column=4, row=4)
porcentaje=tk.Button(text="%", command=func14, width=1, height=1)
porcentaje.grid(column=3, row=5)
borrar=tk.Button(text="<-", command=funcborra, width=1, height=1)
borrar.grid(column=2, row=5)
clear=tk.Button(text="C", command=funclear, width=1, height=1)
clear.grid(column=1, row=5)
punto=tk.Button(text=".", command=funcpunto, width=1, height=1)
punto.grid(column=3, row=4)
igual=tk.Button(text="=", command=funcigual, width=1, height=1)
